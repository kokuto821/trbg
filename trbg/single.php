            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <div class="main__title">
                    ...
                    <ul class="meta">
                        <li class="meta__day">
                            <?php
                                $trbg_post_year = get_the_date( 'Y' );
                                $trbg_post_month = get_the_date( 'm' );
                            ;?>
                            <a href="<?php echo get_month_link( $trbg_post_year , $trbg_post_month ); ?>">
                                <time datetime="<?php echo get_the_date('Y-m-d');?>"><?php echo get_the_date();?>
                            </a>
                        </time>
                    </li>
